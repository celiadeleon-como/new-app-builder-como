const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/comments-BkehKOUM.js","assets/comments-BgV5jwaY.css"])))=>i.map(i=>d[i]);
...
`,f=`      <!-- Drill: Profile & Loyalty (greeting with variables + loyalty progress display) -->
      <div class="cp-detail" data-detail="profile">
...
`,m=`      <!-- Drill: Promo Cards — Featured (instance 1) -->
      <div class="cp-detail" data-detail="promo-cards">
        <div class="cp-detail-header">
          <button class="cp-back">‹</button>
...
`,g=`      <!-- Drill: Promo Cards — More Offers (instance 2 — identical behaviour, own cards & styling) -->
      <div class="cp-detail" data-detail="promo-cards-2">
        <div class="cp-detail-header">
          <button class="cp-back">‹</button>
...
`,_=`      <!-- Drill: Social Links -->
      <div class="cp-detail" data-detail="social">
        <div class="cp-detail-header">
          <button class="cp-back">‹</button>
...
`,v=`        <div class="cp-detail" data-detail="order-again">
          <div class="cp-detail-header">
            <button class="cp-back">‹</button>
...
`,y=`        <div class="cp-detail" data-detail="top-items">
          <div class="cp-detail-header">
            <button class="cp-back">‹</button>
...
`,b=`        <div class="cp-detail" data-detail="menu-categories">
          <div class="cp-detail-header">
            <button class="cp-back">‹</button>
...
`,x=`        <div class="cp-detail" data-detail="menu-reels">
          <div class="cp-detail-header">
            <button class="cp-back">‹</button>
...
`,te=`<div class="cp-page" id="cp-menu" style="display:none;">
    ...
    <div class="ms-options">
      ...
      <button class="ms-option" type="button" data-approach="manual">
        ...
        <span class="ms-option-text">
          ...
          <span class="ms-option-desc">Add menu items by hand in Como. Full control over every dish and price.</span>
        </span>
        <span class="ms-radio"></span>
      </button>
    </div>
  ...
  <div class="ms-screen" data-ms="page-settings">
    <div class="ms-kicker">Menu source<span id="ms-page-settings-kicker-suffix"> · Configure another page</span>
      <button class="ms-kicker-link" type="button" id="ms-page-settings-back">Back</button>
    </div>
    ...
    <div class="ms-section-label">Hero Banner text</div>
  ...
  <div class="ms-screen" data-ms="build-items">
    <button class="ms-back" type="button" id="ms-items-back">
  ...
  <div class="cp-detail ms-item-editor" data-detail="menu-item" id="ms-item-editor">
    <button class="ms-back" type="button" id="ms-item-back">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M15 6l-6 6 6 6"/></svg>
      <span id="ms-item-back-label">Category</span>
    </button>
      ...
      <div class="cp-master">
        ...
        <div class="cp-section open">
          ...
          <div class="cp-body">
            ...
            <div class="cp-toggle-row"><span class="lbl">Our Story</span><span class="toggle" data-bind=".more-tile:nth-child(8)"></span></div>
            <div class="cp-toggle-row"><span class="lbl">Contact Us</span><span class="toggle" data-bind=".more-tile:nth-child(9)"></span></div>
            <div class="cp-toggle-row"><span class="lbl">About Us</span><span class="toggle" data-bind=".more-tile:nth-child(10)"></span></div>
          </div>
        </div>
...
`,re=`<div class="cp-master">
  ...
  <fieldset class="gf-fieldset gf-fieldset-reset" aria-describedby="gf-biz-type-error">
    <legend class="gf-field-label">What best describes your business? <span class="gf-req">*</span></legend>
    <div class="gf-biztype-cards" id="gf-biz-type-row" role="radiogroup" aria-label="Business type">
      <button class="gf-biztype-card" data-biztype="physical" type="button" role="radio" aria-checked="false">
        <span class="gf-biztype-ic">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l1.5-5h15L21 9M4 9h16v10a1 1 0 01-1 1H5a1 1 0 01-1-1V9zM3 9h18"/><path d="M9 20v-6h6v6"/></svg>
        </span>
        <span class="gf-biztype-name">Physical store</span>
      </button>
      <button class="gf-biztype-card" data-biztype="service" type="button" role="radio" aria-checked="false">
        <span class="gf-biztype-ic">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0112 0"/><circle cx="18" cy="8" r="2"/><path d="M18 6.5V5M18 11v-1.5M20.6 8h-1.5M16.9 8h-1.5"/></svg>
        </span>
        <span class="gf-biztype-name">Service provider / Other</span>
      </button>
    </div>
    <div class="gf-field-error" id="gf-biz-type-error" aria-live="polite"></div>
  </fieldset>
          ...
          <div class="app-page" data-page="more">
            ...
            <div class="more-grid">
              ...
              <button class="more-tile hidden-slot">
                ...
                <div>
                  <div class="t-name">Our Story</div>
                  <div class="t-sub">The journey of our beans</div>
                </div>
              </button>
              ...
              <button class="more-tile hidden-slot">
                <div class="t-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 8h.01M11 11h1v5h1"/></svg></div>
                <div>
...
`,`<div class="sm-pane" data-sm-pane="online-ordering" id="sm-oo-pane"
     ...
     data-sm-sub="Confirm the ordering service Como found for this business."
     data-sm-primary="Continue">

  <!-- ---------- Step 1 · pick a provider ---------- -->
  <div class="sm-oo-step active" data-oo-step="chooser"
       data-sm-title="Online ordering"
       data-sm-sub="Confirm the ordering service Como found, then choose which locations will accept orders."
    ...
    <div class="sm-field">
      <div class="sm-label">Ordering service
        <button class="sm-info" type="button" data-tip="Como uses this service for live menus, availability, checkout, and order status.">i</button>
      </div>
      ...
      <div class="sm-hint">Not sure this is correct? Your Como ordering specialist can confirm the setup with you.</div>
    </div>
    <div class="sm-note" style="margin-top:22px">
      ...
      <span><strong>Need help or don’t have ordering yet?</strong><br/>Como will coordinate entitlement and setup with your sales or CSM contact.</span>
    </div>
  ...
  <div class="sm-oo-step" data-oo-step="keys"
       data-sm-title="Online ordering"
       data-sm-sub="Connect an ordering provider so members can order from your menu inside the app. Como stays headless — your provider owns the menu and prices."
    ...
    <div class="sm-section">
      ...
      <div class="sm-field">
        <div class="sm-label">Menu sync frequency
          <button class="sm-info" type="button" data-tip="How often Como re-reads your provider’s menu. More frequent syncs keep 86’d items accurate.">i</button>
        </div>
    ...
    <div class="sm-section">
      ...
      <div class="sm-field">
        <div class="sm-label">“Help with my order” routes to
          <button class="sm-info" type="button" data-tip="Where the support button inside an order goes. Como is Tier 1 for ordering issues, so pick a channel you actually monitor.">i</button>
        </div>
...
`,`<div class="sm-pane sm-submission-pane" data-sm-pane="app-submission" data-pendo-guide-id="app-submission-checklist"
  ...
  <section class="sm-submission-step active" data-submission-step="overview"
           data-sm-title="App submission"
           data-sm-sub="See what each store needs before Como can prepare a native submission. Apple and Google move independently."
  ...
  <section class="sm-submission-step" data-submission-step="accounts"
    ...
    <div class="sm-account-card" data-account-card="google">
      ...
      <div class="sm-account-copy"><h3>Google Play organization</h3><p>Grant Como release access from Play Console.</p><small>A guided checklist opens; you sign in directly with Google.</small></div>
  ...
  <section class="sm-submission-step" data-submission-step="listing"
    ...
    <div class="sm-section">
      ...
      <div class="sm-asset-grid">
        ...
        <button class="sm-asset-card" type="button" data-listing-asset="screens"><span class="sm-asset-preview screens">▯ ▯</span><span><strong>Screenshots</strong><small>Como can generate a starting set</small></span><em data-asset-state="screens">Generate</em></button>
      </div>
    </div>
  ...
  <section class="sm-submission-step" data-submission-step="privacy"
    ...
    <div class="sm-note"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3l9 16H3L12 3z"/><path d="M12 9v4M12 16h.01"/></svg><div>Apple and Google may ask follow-up questions. Como can help translate your answers into store forms, but your business approves the final declarations.</div></div>
  ...
  <section class="sm-submission-step" data-submission-step="submit"
           ...
           data-sm-sub="Choose which stores Como should prepare. This prototype creates a review-ready request; it does not contact either store."
           data-sm-primary="Prepare submission summary" data-sm-back="testing">
    <div class="sm-note ok" data-ready-note><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M8 12l2.5 2.5L16.5 8.5"/></svg><div><b>All setup gates are ready.</b> Review the stores and release choices below before asking Como to prepare the submission.</div></div>
    ...
    <div class="sm-submit-confirm" data-submission-confirmation hidden role="group" aria-label="Confirm submission preparation">
      <div><strong>Prepare a request for Como review?</strong><p>No app-store submission happens now. Como will review the package and ask for your final approval before any external submission.</p></div>
  ...
  <section class="sm-submission-step" data-submission-step="history"
    ...
    <div class="sm-note info"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg><div>Store reviews are handled by Apple and Google. Their timelines and decisions are independent; Como will show requests for changes here.</div></div>
  </section>
</div>

<div class="sm-pane" data-sm-pane="app-store"
     data-sm-title="App Store Connect"
     data-sm-sub="Como submits your iOS builds through this connection. Layer 1 changes still ship instantly over the air."
     data-sm-primary="Save changes">
...
<div class="sm-pane" data-sm-pane="google-play"
    data-sm-title="Google Play"
     data-sm-sub="Where Como uploads your Android bundles and which track they land on."
     data-sm-primary="Save changes">
  ...
  <div class="sm-section">
    ...
    <div class="sm-field">
      <div class="sm-label">Webhook endpoint
        <button class="sm-info" type="button" data-tip="Como POSTs every loyalty and order event to this URL. Retries for 24 hours on failure.">i</button>
      </div>
